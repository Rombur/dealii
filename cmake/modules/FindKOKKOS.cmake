...
IF(Kokkos_FOUND)
  ...
  IF(TARGET Kokkos::kokkos)
    ...
    STRING(LENGTH "${KOKKOS_EXTRA_LD_FLAGS_FULL}" str_length_ld)
    MATH(EXPR length_ld "${str_length_ld} - 24")
    IF(${length_ld} GREATER 0)
      STRING(SUBSTRING "${KOKKOS_EXTRA_LD_FLAGS_FULL}" 23 ${length_ld} KOKKOS_EXTRA_LD_FLAGS)
    ENDIF()
    GET_PROPERTY(KOKKOS_COMPILE_FLAGS_FULL TARGET Kokkos::kokkoscore PROPERTY INTERFACE_COMPILE_OPTIONS)
    STRING(LENGTH "${KOKKOS_COMPILE_FLAGS_FULL}" str_length_c)
    MATH(EXPR length_c "${str_length_c} - 27")
    IF(${length_c} GREATER 0)
      STRING(SUBSTRING "${KOKKOS_COMPILE_FLAGS_FULL}" 26 ${length_c} KOKKOS_COMPILE_FLAGS)
